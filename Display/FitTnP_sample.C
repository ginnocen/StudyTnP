...
/*
  ...
  {
    hTrkEtaPass[i] = (TH1D*)finput->Get(Form("hTrkEtaPass%d"), i);
    hTrkEtaFail[i] = (TH1D*)finput->Get(Form("hTrkEtaFail%d"), i);
    hTrkEtaFail[i] = (TH1D*)finput->Get(Form("hTrkEtaFail%d"), i);
  }
*/
  //get pt histogram
...
//  for(int i = 0; i < nMuPtBin; i ++)
//  {
    //RooDataHist dataTrkPass("dataTrkPass", "dataTrkPass", mass, hTrkPtPass[i]);
    //RooDataHist dataTrkFail("dataTrkFail", "dataTrkFail", mass, hTrkPtFail[i]);
    //RooDataHist dataTrkAll("dataTrkAll", "dataTrkFAll", mass, hTrkPtAll[i]);
